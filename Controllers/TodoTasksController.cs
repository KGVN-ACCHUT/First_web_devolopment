...
namespace First_web_devolopment.Controllers
{
    [Authorize]
    public class TodoTasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,IsCompleted")] TodoTask todoTask)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,IsCompleted")] TodoTask todoTask)
        {
            if (id != todoTask.Id)
            {
                return NotFound();
